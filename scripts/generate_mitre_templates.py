...
MITRE_CTI_URL = "/csse/research/contructive-learning/input/enterprise-attack.json"

SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
OUTPUT_DIR = "/csse/research/contructive-learning/output/theia/tactic_data/templates"
...
OUTCOME_KEYWORDS = [
    "goal", "gained through", "provide the opportunity"
]

RELATIONSHIP_KEYWORDS = [
    "lifecycle", "paired with"
]
...
def main():
    ...
    print("Loading MITRE ATT&CK data from local file...")
